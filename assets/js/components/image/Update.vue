...
export default {
  ...
  computed: {
    ...
    ...mapFields('image/create', {
      created: 'created',
    }),
    ...mapFields('image/update', {
      isLoading: 'isLoading',
      error: 'error',
      retrieved: 'retrieved',
      updated: 'updated',
  ...
  methods: {
    ...mapActions({
      createReset: 'image/create/reset',
      deleteItem: 'image/del/del',
      delReset: 'image/del/reset',
      retrieve: 'image/update/retrieve',
      updateReset: 'image/update/reset',
      update: 'image/update/update',
      updateRetrieved: 'image/update/updateRetrieved',
    }),
