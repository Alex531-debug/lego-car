 ...
 */
final class Version20210224084546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, brand_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, vin VARCHAR(17) NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, status ENUM(\'available\', \'on_order\'), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_773DE69D44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
