...
class CountFilter extends AbstractFilter implements RangeFilterInterface
{
    use CountFilterTrait;
    ...
    protected function filterProperty(string $property, $values, QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, string $operationName = null)
    {
        if (
            ...
            !$this->isPropertyCollectionMapped($property, $resourceClass)
        ) {
            return;
        }
    ...
    protected function addHaving(QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, $alias, $field, $operator, $value)
    {
        ...
        $queryBuilder->addSelect(sprintf('size(%s.%s) as size_%s_%s', $alias, $field, $alias, $field));
