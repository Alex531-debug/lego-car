...
trait CountFilterTrait
{
    ...
    public function getDescription(string $resourceClass): array
    {
        ...
        foreach ($properties as $property => $unused) {
            if(!$this->isPropertyCollectionMapped($property, $resourceClass)) {
                continue;
            }
    ...
    /**
     * Проверяем что данное поле являеться коллекцией
     * @param string $property
     * @param string $resourceClass
     * @param bool $allowAssociation
     * @return bool
     */
    protected function isPropertyCollectionMapped(string $property, string $resourceClass, bool $allowAssociation = false): bool
    {
